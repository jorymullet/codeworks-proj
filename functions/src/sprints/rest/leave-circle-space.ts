...
export const leaveCircleSpace = async (req: Request, res: Response) => {
  // -- Validate
  ...
  if (response.success === false) {
    ...
    if (response.message === '') return res.status(200).send() // it's cool that the user was already deleted
